...
function loadCharts() {
    ...
    e && (document.getElementById("sales-by-locations").innerHTML = "",
    worldemapmarkers = "",
...
(searchResultList = document.getElementById("searchResultList")).addEventListener("keyup", function() {
...
window.addEventListener("load", ()=>{
    ...
    r.onkeyup = ()=>{
        ...
        for (e of t)
            -1 == e.querySelector(".candidate-name").innerHTML.toLowerCase().indexOf(a) ? e.classList.add("d-none") : e.classList.remove("d-none")
    }
}
),
...
(chartRadialbarBasicColors = getChartColorsArray("apply_jobs")) && (options = {
    series: [97],
    chart: {
        type: "radialBar",
        width: 105,
...
(chart = new ApexCharts(document.querySelector("#apply_jobs"),options)).render()),
(chartRadialbarBasicColors = getChartColorsArray("interview_chart")) && (options = {
    series: [89],
    chart: {
        type: "radialBar",
        width: 105,
...
(chart = new ApexCharts(document.querySelector("#interview_chart"),options)).render()),
(chartRadialbarBasicColors = getChartColorsArray("hired_chart")) && (options = {
    series: [64],
    chart: {
        type: "radialBar",
        width: 105,
...
(chart = new ApexCharts(document.querySelector("#hired_chart"),options)).render()),
(chartRadialbarBasicColors = getChartColorsArray("rejected_chart")) && (options = {
    series: [20],
    chart: {
        type: "radialBar",
        width: 105,
...
(chart = new ApexCharts(document.querySelector("#rejected_chart"),options)).render()),
(chartRadialbarBasicColors = getChartColorsArray("new_jobs_chart")) && (options = {
    series: [80],
    chart: {
        type: "radialBar",
        width: 105,
