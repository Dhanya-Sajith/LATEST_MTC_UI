    ...
    var a = document.getElementsByTagName("body")[0]
      , t = (Array.from(document.querySelectorAll(".message-list a")).forEach(function(e) {
        e.addEventListener("click", function(t) {
            ...
            Array.from(document.querySelectorAll(".message-list li.unread")).forEach(function(e) {
    ...
    Array.from(document.querySelectorAll(".email-menu-btn")).forEach(function(e) {
        e.addEventListener("click", function() {
            Array.from(l).forEach(function(e) {
                e.classList.add("menubar-show"),
                t = !0
            })
        })
    }),
    window.addEventListener("click", function(e) {
        document.querySelector(".email-menu-sidebar").classList.contains("menubar-show") && (t || document.querySelector(".email-menu-sidebar").classList.remove("menubar-show"),
        t = !1)
    }),
    favouriteBtn()
}
function checkBoxAll() {
    ...
    function a() {
        ...
        document.getElementById("email-topbar-actions").style.display = 0 < t ? "none" : "block",
        0 < t ? Array.from(e).forEach(function(e) {
            e.checked = !1,
    ...
    Array.from(e).forEach(function(e) {
        e.addEventListener("click", function(e) {
            ...
            document.getElementById("email-topbar-actions").style.display = 0 < l ? "block" : "none"
        })
    }),
    document.getElementById("checkall").onclick = a
}
getJSON("mail-list.init.json", function(e, t) {
    null !== e ? console.log("Something went wrong: " + e) : (allmaillist = t[0].primary,
...
Array.from(document.querySelectorAll(".mail-list a")).forEach(function(l) {
    l.addEventListener("click", function() {
        ...
        l.querySelector(".mail-list-link").hasAttribute("data-type") ? (t = l.querySelector(".mail-list-link").innerHTML,
        e = allmaillist.filter(e=>e.labeltype === t)) : (t = l.querySelector(".mail-list-link").innerHTML,
        document.getElementById("mail-list").innerHTML = "",
        e = "All" != t ? allmaillist.filter(e=>e.tabtype === t) : allmaillist,
    ...
    document.getElementById("removeItemModal").addEventListener("show.bs.modal", function(e) {
        document.getElementById("delete-record").addEventListener("click", function() {
            Array.from(document.querySelectorAll(".message-list li")).forEach(function(e) {
                var t, a;
                e.classList.contains("active") && (t = e.querySelector(".form-check-input").value,
                a = t,
            ...
            document.getElementById("email-topbar-actions") && (document.getElementById("email-topbar-actions").style.display = "none"),
    ...
    document.querySelectorAll(".remove-mail").forEach(function(t) {
        t.addEventListener("click", function(e) {
            ...
            document.getElementById("delete-record").addEventListener("click", function() {
                var t;
                t = a,
                loadMailData(allmaillist = allmaillist.filter(function(e) {
                    return e.id != t
                })),
...
var markAllReadBtn = document.getElementById("mark-all-read")
  , dummyUserImage = (markAllReadBtn.addEventListener("click", function(e) {
    0 === document.querySelectorAll(".message-list li.unread").length && (document.getElementById("unreadConversations").style.display = "block",
    setTimeout(function() {
    ...
    Array.from(document.querySelectorAll(".message-list li")).forEach(function(c) {
        c.addEventListener("click", function() {
            var e = c.querySelector(".checkbox-wrapper-mail .form-check-input").value
              , e = (document.querySelector(".remove-mail").setAttribute("data-remove-id", e),
...
document.querySelectorAll(".email-chat-list a").forEach(function(l) {
    var e, t;
    l.classList.contains("active") && (document.getElementById("emailchat-detailElem").style.display = "block",
    e = document.querySelector(".email-chat-list a.active").querySelector(".chatlist-user-name").innerHTML,
    t = document.querySelector(".email-chat-list a.active").querySelector(".chatlist-user-image img").getAttribute("src"),
    document.querySelector(".email-chat-detail .profile-username").innerHTML = e,
    ...
    l.addEventListener("click", function(e) {
        ...
        l.querySelector(".chatlist-user-name").innerHTML)
          ...
          , t = (document.querySelector(".email-chat-detail .profile-username").innerHTML = t,
