...
@Component({
  selector: 'app-com-assessmentresult-by-hr',
  templateUrl: './com-assessmentresult-by-hr.component.html',
  styleUrls: ['./com-assessmentresult-by-hr.component.scss']
})
export class ComAssessmentresultByHRComponent implements OnInit {
