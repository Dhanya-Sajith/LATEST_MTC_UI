...
@Component({
  selector: 'app-editemployeeprofile',
  templateUrl: './editemployeeprofile.component.html',
  styleUrls: ['./editemployeeprofile.component.scss']
})
 ...
 // employee_code= (<HTMLInputElement>document.getElementById("nonactiveEmp")).value;
  ...
  // this.fetchlang();
   ...
   this.fetchFamStatus();
    ...
    this.apicall.restrictsalaryupdate(this.em_pcode).subscribe((res)=>{
      this.listrestiction=res;
      //alert(res)
  ...
  else
  {
    ...
    this.apicall.EmployeeBasicdetails(this.empcdd).subscribe((res)=>{
      ...
      this.empBasicForm.controls['profilephoto'].setValue(this.dispbasicdet[0].profilephoto);
       ...
       if(this.dispbasicdet[0].CONTRACTOR_NAME != 0 || this.dispbasicdet[0].PER_HOUR_RATE != 0 )
       {
        this.chnagecontractFn(2);
       }
       else
