...
@Component({
  ...
  templateUrl: './business-trip-request.component.html',
  styleUrls: ['./business-trip-request.component.scss']
})
export class BusinessTripRequestComponent implements OnInit {
